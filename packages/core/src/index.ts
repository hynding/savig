...
export { addRect, addEllipse, addPath, addText, setKeyframe, setTrim, setTrimKeyframe, setRepeat, setBaseTransform, removeObjects, outlineStrokePath, blendPaths } from './build';
