...
export { addRect, addEllipse, addPath, addText, setKeyframe, setTrim, setTrimKeyframe, setRepeat, setBaseTransform, setAnchor, removeObjects, outlineStrokePath, blendPaths } from './build';
