...
-- Idempotent AND enforcing: if the bucket already exists (e.g. dashboard-created), the conflict
-- path re-asserts public = false rather than silently leaving a pre-existing public bucket public.
